...
!!! info "Quick Overview"
    My public engineering knowledge base documenting everything I learn while becoming a better software engineer and building products in public.
...
This repository contains my daily learning notes covering:
...
- Production-level AI knowledge
- Multiple shipped products
- Public documentation of everything I learned
---

## 🔗 Resources

- [:material-github: Source Code](https://github.com/thisisankit27/5-month-roadmap){ target="_blank" rel="noopener" }
- [:material-youtube: Vibe Through Code](https://youtube.com/@VibeThroughCode){ target="_blank" rel="noopener" }
